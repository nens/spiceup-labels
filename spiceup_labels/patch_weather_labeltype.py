...
def create_aggregate(code):
    ...
    method = (
        "max" if code.endswith("summary") else "mean"
    )  # Summary mag niet middelen dus pakt max
    value = [
...
def main():
    ...
    labeltype_uuid = "a686583a-da6c-40da-a001-32ed7412655b"
    
    configure_logger(logging.DEBUG)
    logger = logging.getLogger("labellogger")
    
    logger.info("Start creation of weather labeltype")
